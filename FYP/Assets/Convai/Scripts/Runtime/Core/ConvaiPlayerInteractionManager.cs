...
namespace Convai.Scripts.Runtime.Core
{
    public class ConvaiPlayerInteractionManager : MonoBehaviour
    {
        ...
        public void HandleSendText()
        {
            ...
            if (_currentInputField != null && _convaiNPC.isCharacterActive) { HandleInputSubmission(_currentInputField.text);Debug.Log("CALLINGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG"); }
        }
        ...
        public void setInputField(TMP_InputField i)
        {
